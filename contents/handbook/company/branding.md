...
> **Note:** This page currently refers only to this website (posthog.com). It will later be updated to also include information about app.posthog.com following the rebrand. <!-- Is there a date, firm or otherwise, when this rebranding will take place? If so, the date should be listed here. -->
...
These dividers should be 35px below H2 text, and any body copy text below should be 35px from the divider. <!-- The phrase "any body copy text" read somewhat akwardly, is there a better way to put it? -->
...
Most of the menus on PostHog will be in tones of grey with pops of color for clicked pages. The most common menu featured on the bottom of the website page holds 5 <!-- Consider spelling out the number --> sections for users to navigate the website. This menu is Mid Grey (#BEBEBE), and its size, while occupying the entire length of the screen in width, is 315px in height. <!-- This last sentence may need rewording. It was difficult to assess if the size is 315px in height only while occupying the entire length of the screen in width or if it's 315px tall **and** it needs to occupy the entire length of the screen in with. Depending on which case is correct, the sentence could also read, "This menu is Mid Grey (#BEBEBE), its size is 315px in height, and it takes up the entire length of the screen in width." -->
...
The last menu is the navigation menu, which can be found in Docs <!-- Should there be a hyperlink here pointing to where in "Docs" the navigation menu is found? -->, and it uses 'Small Text.'
